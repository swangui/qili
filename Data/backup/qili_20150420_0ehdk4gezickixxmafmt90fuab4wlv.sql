/* This file is created by MySQLReback 2015-04-20 12:39:42 */
 /* 创建表结构 `my_access`  */
 ...
 /* 插入数据 `my_category` */
 INSERT INTO `my_category` VALUES ('1','0','Vip','0','1','0','vip-membership','VIP会员申请','VIP会员申请','VIP会员申请','1',null);/* MySQLReback Separation */
 /* 创建表结构 `my_model`  */
 ...
 /* 插入数据 `my_model` */
 INSERT INTO `my_model` VALUES ('1','单页模型','Content','10','条数据','上一页','下一页','首页','末页','<ul><li>%first%</li><li>%upPage%</li><li>%linkPage%</li><li>%downPage%</li><li>%end%</li><li><span class=\\\\\\\"pageinfo\\\\\\\">共 <strong>%totalRow%</strong> %header% <strong>%nowPage%/%totalPage%</strong>页</span></li></ul>'),('2','VIP会员模型','Vip','5','条数据','«','»','首页','末页','<ul class=\'pagination\'>   <li>%upPage%</li>   <li>%linkPage%</li>   <li>%downPage%</li> </ul>');/* MySQLReback Separation */
 /* 创建表结构 `my_node`  */
 ...
 /* 插入数据 `my_other` */
 INSERT INTO `my_other` VALUES ('6','版权信息','copyright','© Company 2015 上海仕辛商贸有限公司','1');/* MySQLReback Separation */
 /* 创建表结构 `my_role`  */
 ...
 DROP TABLE IF EXISTS `my_set`;/* MySQLReback Separation */ CREATE TABLE `my_set` (
  ...
  `mail_server` varchar(80) NOT NULL,
  `mail_usermail` varchar(80) NOT NULL,
 ...
 /* 插入数据 `my_set` */
 INSERT INTO `my_set` VALUES ('21','5','1200','3600','2015/1/19/54bcd4b876417.jpg','2015/1/19/favicon.ico','2015/1/19/54bcb329e4e1c.jpg','smtp.qq.com','330130180@qq.com','330130180','fdf','<p>您好：</p><p> &nbsp; &nbsp; ...</p>');/* MySQLReback Separation */
 /* 创建表结构 `my_survey`  */
 ...
 /* 插入数据 `my_tjdate` */
 INSERT INTO `my_tjdate` VALUES ('1','20150119','576'),('2','20150120','1109'),('3','20150121','814'),('4','20150122','96'),('5','20150123','704'),('6','20150125','74'),('7','20150126','182'),('8','20150127','570'),('9','20150128','168'),('10','20150129','118'),('11','20150130','75'),('12','20150131','29'),('13','20150201','13'),('14','20150202','15'),('15','20150203','5'),('16','20150204','8'),('17','20150205','249'),('18','20150206','63'),('19','20150417','548'),('20','20150418','209'),('21','20150419','292'),('22','20150420','33');/* MySQLReback Separation */
 /* 创建表结构 `my_tjurl`  */
 ...
 /* 插入数据 `my_tjurl` */
 INSERT INTO `my_tjurl` VALUES ('1','/','935'),('2','/contact-us25.html','8'),('3','/index.html','36'),('4','/contact-us26.html','38'),('5','/online-feedback.html','190'),('6','/contact.html','220'),('7','/campus-recruitment.html','132'),('8','/campus-recruitment/2','7'),('9','/campus-recruitment/1','28'),('10','/campus-recruitment-2.html','183'),('11','/resume-2.html','109'),('12','/resume.html','18'),('13','/message/insert','6'),('14','/message.html','5'),('15','/campus-recruitment-1.html','23'),('16','/resume-1.html','31'),('17','/social-recruitment.html','63'),('18','/occupation-development.html','62'),('19','/talent-concept.html','124'),('20','/industry-information.html','229'),('21','/dynamic-company.html','56'),('22','/company-announcement.html','107'),('23','/industry-information/2','21'),('24','/industry-information','1'),('25','/industry-information/1','7'),('26','/industry-information-2.html','30'),('27','/article/checkHits?id=2','31'),('28','/industry-information-1.html','17'),('29','/article/checkHits?id=1','18'),('30','/industry-information-4.html','16'),('31','/article/checkHits?id=4','14'),('32','/industry-information-3.html','21'),('33','/article/checkHits?id=3','22'),('34','/industry-information-6.html','35'),('35','/article/checkHits?id=6','36'),('36','/industry-information-5.html','31'),('37','/article/checkHits?id=5','27'),('38','/b-city-complex.html','40'),('39','/property-management.html','42'),('40','/land-development.html','94'),('41','/home.html','398'),('42','/search','8'),('43','/professional-team.html','31'),('44','/organizational-structure.html','43'),('45','/leadership-speech.html','39'),('46','/enterprise-idea.html','60'),('47','/company-profile.html','153'),('48','/city-complex.html','72'),('49','/elaborate-housing.html','250'),('50','/elaborate-housing-1.html','242'),('51','/product/checkHits?id=1','44'),('52','/elaborate-housing-5.html','10'),('53','/product/checkHits?id=5','2'),('54','/elaborate-housing-3.html','5'),('55','/elaborate-housing-2.html','4'),('56','/elaborate-housing-4.html','6'),('57','/elaborate-housing/2','2'),('58','/elaborate-housing/3','1'),('59','/elaborate-housing/5','2'),('60','/elaborate-housing/4','1'),('61','/product/setHits?id=1','203'),('62','/city-complex-6.html','56'),('63','/product/setHits?id=6','91'),('64','/dynamic-company-7.html','12'),('65','/article/checkHits?id=7','15'),('66','/search.html','24'),('67','/company-profile','1'),('68','/partners','35'),('69','/partners.html','51'),('70','/partners/4','3'),('71','/partners/5','2'),('72','/partners/1','1'),('73','/company-announcement-8.html','11'),('74','/article/checkHits?id=8','14'),('75','/search/2','2'),('76','/search/1','3'),('77','/industry-information-9.html','4'),('78','/article/checkHits?id=9','7'),('79','/industry-information-10.html','6'),('80','/article/checkHits?id=10','10'),('81','/social-recruitment-3.html','4'),('82','/social-recruitment-5.html','3'),('83','/resume-5.html','7'),('84','/social-recruitment-4.html','2'),('85','/resume-3.html','1'),('86','/partners/2','1'),('87','/vip-membership','406'),('88','/vip-membership.html','219'),('89','/vip/uploadify','185'),('90','/Vip/index?id=1','19'),('91','/Vip/','16'),('92','/vip/insert','50');/* MySQLReback Separation */
 /* 创建表结构 `my_user`  */
 ...
 /* 插入数据 `my_user` */
 INSERT INTO `my_user` VALUES ('1','admin','超级管理员','e10adc3949ba59abbe56e057f20f883e','1429499677','127.0.0.1','425','0','1422496027',null,null,'1382963329','1384269896','1','0');/* MySQLReback Separation */
 /* 创建表结构 `my_vip`  */
 ...
 /* 插入数据 `my_vip` */
 INSERT INTO `my_vip` VALUES ('11','1','1','绮丽永生花','杨涛','15102157626',null,'330130180','上海闵行区','1年以上','1万','2015/4/19/55335ec85f5e1.jpg','2015/4/19/55335ec894c5f.jpg','<p>该会员已通过审核，审核人：徐</p>','127.0.0.1','1429429961','1429430119');/* MySQLReback Separation */